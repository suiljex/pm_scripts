...
#В .pm_db хранятся репозитории с проектами
#.pm_db/<название> - репозиторий отдельного проекта
#В репозитории хранятся архивированные версии проектов
#Формат имени архива: <название>_<метка_времени>.tar.xz
...
show_help()
{
  ...
  printf "\t\t--export-db - Экспортировать хранилище в корень $0\n"
